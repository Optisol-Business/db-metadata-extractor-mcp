...
```bash
git clone https://github.com/yourusername/db-metadata-extractor-mcp.git
...
- GitHub Issues: https://github.com/yourusername/db-metadata-extractor-mcp/issues
- Documentation: See MCP_REGISTRY_GUIDE.md

## Links

- **PyPI**: https://pypi.org/project/db-metadata-extractor-mcp/
- **GitHub**: https://github.com/yourusername/db-metadata-extractor-mcp
